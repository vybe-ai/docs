...
description: New updates and improvements for VYDEO
icon: rocket-launch
---

<Update label="2025-04-24" description="v0.0.13">
  ## [Private Beta]: Improvements to VYDEO

  <Frame>
    <img src="https://cdn.vydeo.app/vydeo_private_beta_cover.jpg" alt="VYDEO private beta launch" />
  </Frame>
...
<Update label="2025-04-10" description="v0.0.12">
  ...
  Introducing the first look at VYDEO! We're revolutionizing video editing by embedding AI at the core of the motion graphics creation process. Generate stunning visuals, from intricate 3D objects to dynamic text animations, all in seconds.
  ...
  * **Contextual Motion Design:** VYDEO's AI analyzes your footage and suggests relevant motion graphic elements and styles.
  ...
  * **Natural Language Input:** Describe the graphics you want, and watch VYDEO bring them to life.
